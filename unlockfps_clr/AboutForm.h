...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->labelTitle->Location = System::Drawing::Point(0, 9);
			this->labelTitle->Name = L"labelTitle";
			this->labelTitle->Padding = System::Windows::Forms::Padding(0, 5, 0, 0);
			this->labelTitle->Size = System::Drawing::Size(363, 49);
			...
			this->linkLabelDescription->Location = System::Drawing::Point(0, 58);
			this->linkLabelDescription->Name = L"linkLabelDescription";
			this->linkLabelDescription->Size = System::Drawing::Size(353, 18);
			...
			this->linkLabelSource->Location = System::Drawing::Point(0, 87);
			this->linkLabelSource->Name = L"linkLabelSource";
			this->linkLabelSource->Size = System::Drawing::Size(363, 63);
			...
			this->linkLabelIssues->Location = System::Drawing::Point(0, 123);
			this->linkLabelIssues->Name = L"linkLabelIssues";
			this->linkLabelIssues->Size = System::Drawing::Size(363, 120);
			...
			this->ClientSize = System::Drawing::Size(365, 244);
